...
export const registrationContent: TextContent[][] = [
  [
...
export const institutionContent: TextContent[] = [
...
export const invalidCredentialsContent: TextContent[] = [
...
export const loginErrorContent: TextContent[] = [
  {
